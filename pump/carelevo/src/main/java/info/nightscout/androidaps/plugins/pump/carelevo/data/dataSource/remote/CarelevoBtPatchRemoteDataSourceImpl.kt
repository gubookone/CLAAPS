...
import info.nightscout.androidaps.plugins.pump.carelevo.data.protocol.transformer.CarelevoDateTimeToByteTransformerImpl
import info.nightscout.androidaps.plugins.pump.carelevo.data.protocol.transformer.CarelevoDoubleToByteTransformerImpl
import info.nightscout.androidaps.plugins.pump.carelevo.data.protocol.transformer.CarelevoIntegerDivideUnitToByteTransformerImpl
import info.nightscout.androidaps.plugins.pump.carelevo.data.protocol.transformer.CarelevoIntegerToByteTransformerImpl
import info.nightscout.androidaps.plugins.pump.carelevo.data.protocol.transformer.CarelevoSubIdToByteTransformerImpl
import info.nightscout.androidaps.plugins.pump.carelevo.domain.model.bt.isPatchProtocol
